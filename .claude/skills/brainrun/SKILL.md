...
| `references/erudition.md`                | Degrés de difficulté (échelle à 10 niveaux façon Ascension), agrégation des effets, déblocage, points d'intégration, intégrité vis-à-vis du classement       | ajout/modif d'un niveau ou d'un modificateur de difficulté, tout ce qui dépend du degré   |
