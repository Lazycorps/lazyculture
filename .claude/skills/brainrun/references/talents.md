...
```
VALIANT_HEART ──▶ ACT_SHIELD ──▶ BOSS_SHIELD ─┐
                                                ├──▶ SECOND_WIND (ultime)
DESPERATE_RAGE ─┐                              │
COLD_BLOOD ─────┴──▶ VITALITY ────────────────┘
```
...
| `BOSS_SHIELD`    | 3          | `ACT_SHIELD`                     | `SHIELD_ON_BOSS_START`                          |
| `SECOND_WIND`    | 4 (ultime) | `BOSS_SHIELD` OU `VITALITY`      | `ULTIMATE_REVIVE_2HP`                           |
...
demandée en cours de conception.
