<template>
  <NuxtLayout name="admin">
    <v-card flat rounded class="my-auto mx-auto pa-5" style="max-width: 1500px; min-width: 800px;">
      <v-data-table :headers="computedHeaders" :items="filteredQuestions" :items-per-page="10" fixed-header
        height="100%" style="max-height: 650px;" class="fill-width">
        <template v-slot:top>
          <v-toolbar class="pt-4 pl-4">
            ...
            <v-switch v-model="showReportedQuestions" color="green" label="Questions Signalées"
              class="mr-10"></v-switch>
      ...
      <v-dialog v-model="dialog" max-width="800px">
        <v-card>
          ...
          <v-card-text>
            ...
            <v-textarea v-model="editedItem.data.commentaire" label="Commentaire" rows="2" auto-grow
              density="compact" />
