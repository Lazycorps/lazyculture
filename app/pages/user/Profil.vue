    ...
    >
      <div class="space-y-4">
        ...
        <div class="space-y-4">
          ...
          >
            <p class="text-xs text-gray-500">Vous n'avez pas encore joué en mode Battle Royale.</p>
          </div>
        ...
        >
          ...
          <div class="flex-1 w-full text-center sm:text-left space-y-3">
            <div>
              ...
              <p class="text-xs text-gray-400 font-medium">{{ showdownRank.points }} LP cumulés</p>
            </div>
