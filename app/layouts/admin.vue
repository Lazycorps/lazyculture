          ...
          <div class="space-y-1">
            ...
            >
              <UIcon
                ...
                class="text-xl group-hover:scale-110 transition-transform"
              />
              <span class="font-semibold font-display tracking-wide">Aventures</span>
            </NuxtLink>
            <NuxtLink
              to="/admin/cosmetics"
              class="flex items-center space-x-3 px-4 py-3 rounded-xl text-gray-400 hover:text-white hover:bg-white/5 transition-all group"
            ...
            >
              <UIcon
                ...
                class="text-xl group-hover:scale-110 transition-transform"
              />
              <span class="font-semibold font-display tracking-wide">Avatars & Cadres</span>
            </NuxtLink>
          </div>
        </div>
          ...
          <div class="space-y-1">
            ...
            >
              <UIcon
                ...
                class="text-xl group-hover:scale-110 transition-transform"
              />
              <span class="font-semibold font-display tracking-wide">CultureQuiz</span>
            </NuxtLink>
            <NuxtLink
            ...
            >
              <UIcon
                ...
                class="text-xl group-hover:scale-110 transition-transform"
              />
              <span class="font-semibold font-display tracking-wide">QuipoQuiz</span>
            </NuxtLink>
          </div>
        </div>
          ...
          <div class="space-y-1">
            ...
            >
              <UIcon
                ...
                class="text-xl group-hover:scale-110 transition-transform"
              />
              <span class="font-semibold font-display tracking-wide">Notifications</span>
            </NuxtLink>
          </div>
        </div>
      </nav>
    ...
    >
      ...
      >
        <UIcon
          ...
          class="text-xl group-hover:scale-110 transition-transform mb-1"
        />
        <span class="text-[10px] font-bold font-display">Aventures</span>
      </NuxtLink>
      ...
      >
        <UIcon
          ...
          class="text-xl group-hover:scale-110 transition-transform mb-1"
        />
        <span class="text-[10px] font-bold font-display">Avatars</span>
      </NuxtLink>
      ...
      >
        <UIcon
          ...
          class="text-xl group-hover:scale-110 transition-transform mb-1"
        />
        <span class="text-[10px] font-bold font-display">CultureQuiz</span>
      </NuxtLink>
      ...
      >
        <UIcon
          ...
          class="text-xl group-hover:scale-110 transition-transform mb-1"
        />
        <span class="text-[10px] font-bold font-display">QuipoQuiz</span>
      </NuxtLink>
      ...
      >
        <UIcon
          ...
          class="text-xl group-hover:scale-110 transition-transform mb-1"
        />
        <span class="text-[10px] font-bold font-display">Notifs</span>
      </NuxtLink>
    </nav>
  </div>
</template>
