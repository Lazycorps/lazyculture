              ...
              <div class="relative">
                ...
                <transition name="pop-in">
                  <div
                    ...
                    class="absolute -top-3.5 -right-3.5 bg-slate-950 border border-violet-500/50 rounded-full w-6 h-6 flex items-center justify-center text-xs shadow-lg animate-emote-bounce z-10"
                  >
